/**
 * Loading skeletons shown while the folders query is in flight.
 */

export interface FolderGridSkeletonProps {
  count?: number;
}

export function FolderGridSkeleton({ count = 10 }: FolderGridSkeletonProps) {
  return (
...
export interface FolderTableSkeletonProps {
  rows?: number;
}

export function FolderTableSkeleton({ rows = 6 }: FolderTableSkeletonProps) {
  return (
