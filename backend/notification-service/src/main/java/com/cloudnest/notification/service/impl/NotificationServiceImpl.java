...
public class NotificationServiceImpl implements NotificationService {
    ...
    /**
     * Deletes all read notifications for a specific user ("clear").
     */
    @Override
    public void deleteAllRead(Long userId) {
        log.debug("Deleting all read notifications for userId={}", userId);

        int deleted = notificationRepository.deleteReadNotifications(userId);
        log.info("Deleted {} read notification(s) for userId={}", deleted, userId);
    }
