...
public class Notification {
    ...
    public enum NotificationType {
        ...
        /**
         * A successful sign-in was recorded for the user's account
         * (a known device).
         */
        LOGIN_ALERT,

        /**
         * A sign-in was recorded from a device not seen before for this
         * account — a potential security concern.
         */
        UNKNOWN_DEVICE_LOGIN,

        /**
         * The user's password was changed from the settings page.
         */
        PASSWORD_CHANGED,

        /**
         * The user's password was reset through the forgot-password flow.
         */
        PASSWORD_RESET,
